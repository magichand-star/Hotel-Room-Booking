...
--
-- Хост: de-fra8-vhost1.rackcorp.com:3324
-- Үүссэн цаг: 2017 оны 8-р сарын 13., 17:30
-- Сервэрийн хувилбар: 5.7.17
-- PHP хувилбар: 5.2.16
...
--
-- Хүснэгтийн бүтэц `pm_activity_file`
--
...
--
-- Хүснэгтийн бүтэц `pm_activity_session`
--
...
--
-- Хүснэгтийн бүтэц `pm_activity_session_hour`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_article`
--
...
--
-- Хүснэгтийн бүтэц `pm_article_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_article_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_booking`
--
...
--
-- Хүснэгтийн бүтэц `pm_booking_activity`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_currency`
--
...
--
-- Хүснэгтийн бүтэц `pm_destination`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_destination`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_facility`
--
...
--
-- Хүснэгтийн бүтэц `pm_facility_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_facility_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_hotel`
--
...
--
-- Хүснэгтийн бүтэц `pm_hotel_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_hotel_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_lang`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_lang_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_location`
--
...
--
-- Хүснэгтийн бүтэц `pm_media_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_page`
--
...
(1, 1, 'Нүүр', 'Нүүр', '', 'Нүүр', '', '', 'index,follow', '', '', '<blockquote class="text-center">\r\n<p>Та Дарь-Эхийн түлхүүр цэцэрлэгт хүрээлэнд мод эзэмших эрхтэй.</p>\r\n</blockquote>\r\n', '', NULL, 'home', 'home', 1, 0, 1, 1, 1, 1478177832, 1493125481, 0, 0, 0),
...
(7, 1, 'Амралтын газар', 'Амралтын газар', '', 'Амралтын газар', 'camp', '', 'index,follow', '', '', '', '', NULL, 'hotel', 'hotel', 1, 0, 0, 1, 5, 1478177832, 1483923773, 1, 0, 0),
(7, 2, 'Tourist camp', 'Tourist camp', '', 'Tourist camp', 'hotels-tourist-camp', '', 'index,follow', '', '', '', '', NULL, 'hotel', 'hotel', 1, 0, 0, 1, 5, 1478177832, 1483923773, 1, 0, 0),
...
(9, 1, 'Зочид буудал', 'Зочид буудал', '', 'Зочид буудал', 'a', '', 'index,follow', '', '', '', '', NULL, 'hotels', 'hotel', 1, 0, 0, 1, 3, 1478177832, 1483925184, 0, 0, 1),
(9, 2, 'Hotel', 'Hotel', '', 'Hotel', 'a', '', 'index,follow', '', '', '', '', NULL, 'hotels', 'hotel', 1, 0, 0, 1, 3, 1478177832, 1483925184, 0, 0, 1),
...
(17, 1, 'Мод зарах', 'Мод зарах', '', 'Мод зарах', 'sale', '', 'index,follow', NULL, '', '', '', NULL, 'wood', 'wood', 1, 0, 0, 1, 17, 1478489653, 1483355323, 0, NULL, NULL),
(17, 2, 'Sale', 'Sale', 'Sale', 'Sale', 'sale', '', 'index,follow', NULL, '', '', '', NULL, 'wood', 'wood', 1, 0, 0, 1, 17, 1478489653, 1483355323, 0, NULL, NULL);

-- --------------------------------------------------------

--
-- Хүснэгтийн бүтэц `pm_page_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_room`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_room_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_service`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_slide`
--
...
--
-- Хүснэгтийн бүтэц `pm_slide_file`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_slide_file`
--

INSERT INTO `pm_slide_file` (`id`, `lang`, `id_item`, `home`, `checked`, `rank`, `file`, `label`, `type`) VALUES
(14, 1, 7, NULL, 1, 4, '15415912-10207164100652116-1903015852-n.jpg', NULL, 'image'),
(14, 2, 7, NULL, 1, 4, '15415912-10207164100652116-1903015852-n.jpg', NULL, 'image');

-- --------------------------------------------------------

--
-- Хүснэгтийн бүтэц `pm_tag`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_text`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_tree`
--

INSERT INTO `pm_tree` (`id`, `code`, `name`, `age`, `status`, `owner`, `email`, `description`) VALUES
...
(180, 'Layer2copy120_10', 'Голт бор', 3, 'зарагдсан', 'Ганзориг Гомбосүрэн', 'Ganzorig Gombosuren', ''),
...
(803, 'Layer2copy102_3', 'Голт бор', 3, 'зарагдсан', 'Чүлтэм Амартайван', '', ''),
...
(933, 'Layer2copy94_17', 'Нарс', 3, 'зарагдсан', 'Chultem Mandahtsetseg', '', '2016.9.15'),
(934, 'Layer2copy95_17', 'Голт бор', 3, 'зарагдаагүй', '', '', ''),
(935, 'Layer2copy96_17', 'Голт бор', 3, 'зарагдсан', 'Uyanga Adilbish', 'UYANGA@GMAIL.COM', '2017.1.12'),
(936, 'Layer2copy97_15', 'Нарс', 3, 'зарагдсан', 'Otgonbayar Bayasgalan', '', 'gol mod'),
(937, 'Layer2copy98_15', 'Голт бор', 3, 'зарагдаагүй', '', '', ''),
(938, 'Layer2copy99_15', 'Голт бор', 3, 'зарагдаагүй', '', '', ''),
(939, 'Layer2copy100_15', 'Нарс', 3, 'зарагдсан', 'Nyamsuren Adilbish', '', '2016.9.15'),
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_user`
--
...
(1, 'Administrator', 'admin@admin.com', 'admin', '9931c398a7f44be162d5e5eb61ccf2c1', 'administrator', 1483304195, 1485145993, 1, '', '', '', '', '', '', '', '', ''),
(2, 'Otgonbayar', 'info@taracode.mn', 'chultem', 'd9544f46dcdc95ab7fb943171f3548ad', 'manager', 1484036618, 1484130890, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Хүснэгтийн бүтэц `pm_wd`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_wd`
--

INSERT INTO `pm_wd` (`id`, `code`, `name`, `age`, `status`, `owner`, `email`, `description`) VALUES
(1453, 'Layer2copy97_15', 'Нарс', 3, 'зарагдсан', 'O.Bayasgalan', '', 'O.Bayasgalan'),
(1454, 'Layer2copy100_15', 'Нарс', 3, 'зарагдсан', 'Nyamsuren Adilbish', '', 'Nyansuren Adilbish'),
(1456, 'Layer2copy94_17', 'Нарс', 3, 'зарагдсан', 'Chultem Mandahtsetseg', '', 'Chultem Mandahtsetseg'),
(1461, 'Layer2copy120_10', 'Голт бор', 3, 'зарагдсан', 'ГАНЗОРИГ ГОМБОСҮРЭН', 'ganzorig@gmail.com', 'Г.Ганзориг'),
(1460, 'Layer2copy96_17', 'Голт бор', 3, 'зарагдсан', 'Uyanga Adilbish', 'UYAN@GMAIL.COM', 'Uyan Adli'),
(1462, 'Layer2copy102_3', 'Голт бор', 3, 'зарагдсан', 'Чүлтэм Амартайван', 'amraa@gmail.com', 'Чүлтэм Амартайван'),
(1463, 'Layer2copy102_22', 'Голт бор', 3, 'зарагдсан', 'Chultem Namuuntuul', 'namuun@yahoo.com', 'nabuunaa');

-- --------------------------------------------------------

--
-- Хүснэгтийн бүтэц `pm_widget`
--
...
--
-- Хүснэгтийн өгөгдлийг устгах `pm_widget`
--
